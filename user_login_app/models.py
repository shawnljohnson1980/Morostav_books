...
class UserManager(BaseUserManager):
    def create_user(self, email, username, first_name, last_name, password, confirm_password=None):
        if not email:
        ...
        if len(password) < 8:
            raise ValueError("Password must be a minimum of 8 characters in length.")
